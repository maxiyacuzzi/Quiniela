...
// Mismo color por jurisdicción que en /pantalla y /ultimo-sorteo (con
// variante clara, ya que esta página sigue el tema del sistema).
const COLOR_JURISDICCION: Record<string, string> = {
  ciudad: "text-blue-600 dark:text-blue-400",
  provincia: "text-red-600 dark:text-red-400",
  cordoba: "text-green-600 dark:text-green-400",
  "santa-fe": "text-yellow-600 dark:text-yellow-400",
  "entre-rios": "text-purple-600 dark:text-purple-400",
};
          ...
          <section key={fila.slug}>
            <h2
              className={`mb-3 text-lg font-semibold ${
                COLOR_JURISDICCION[fila.slug] ?? "text-neutral-800 dark:text-neutral-200"
              }`}
            >
              {fila.nombre}
            </h2>
