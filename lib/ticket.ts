...
- jurisdiccion: una de estas opciones EXACTAS: ${SLUGS_JURISDICCION.join(", ")}, desconocido. Mapeá nombres o abreviaturas comunes del ticket a estas opciones (ej: "CABA"/"Cap"/"Ciudad" -> ciudad; "Bs As"/"PBA"/"Pcia"/"Buenos Aires"/"Provincia" -> provincia; "Cba"/"Córdoba" -> cordoba; "Sta Fe"/"SF"/"Santa Fe" -> santa-fe; "ER"/"Entre Ríos" -> entre-rios). Si no está claro, poné "desconocido".
